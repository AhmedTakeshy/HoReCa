            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <Link href="/" className="flex justify-center lg:justify-start">
                            <Image src={logo} width={160} height={75} alt="logo" className="-ml-6" />
                        </Link>
                        <p className="py-8 text-sm dark:text-slate-300 text-slate-700 lg:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ?</p>
                        <Link href="/contact" className="py-2.5 px-5 h-9 block w-fit bg-indigo-500 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                            Contact us
                        </Link>
                    </div>
                    {/* <!--End Col--> */}
                    <div className="lg:mx-auto text-left ">
                        <ul className="text-sm  transition-all duration-500">
                            <h4 className="text-lg text-gray-900 dark:text-white font-medium mb-7">Horeca</h4>
                            <li className="mb-6"><Link href="#" className="text-gray-600 dark:text-slate-200 dark:hover:text-slate-400 hover:text-gray-900">Home</Link></li>
                            <li className="mb-6"><Link href="/about" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">About</Link></li>
                            <li><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">Pricing</Link></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div className="lg:mx-auto text-left ">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">Figma UI System</Link></li>
                            <li className="mb-6"><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">Icons Assets</Link></li>
                            <li><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">Responsive Blocks</Link></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 dark:text-white font-medium mb-7">Support</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400text-gray-600 hover:text-gray-900">Customer Support</Link></li>
                            <li className="mb-6"><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">Terms & Conditions</Link></li>
                            <li ><Link href="#" className="dark:text-slate-200 dark:hover:text-slate-400 text-gray-600 hover:text-gray-900">Privacy Policy</Link></li>
                        </ul>
                    </div>
                </div>
                {/* <!--Grid--> */}
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-700 dark:text-white ">©<Link className="hover:underline" href="/"> Horeca</Link> 2024, All rights reserved.</span>
                    ...
                    ">
                            ...
                            <Link href="#" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
