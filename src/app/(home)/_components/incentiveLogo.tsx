...
export default function IncentiveLogo() {
    return (
        <section className="pt-24 mb-12 relative">
            <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
                <div className="flex flex-col gap-11 items-center p-11 rounded-xl justify-center">
                    <div className="box max-w-md w-full grid place-items-center">
                        <Image src={logo} width={200} height={75} alt="logo" />
                        <p className="mt-3 text-center font-normal text-xl leading-8 ">Lowest Prices Best Quality
                            Shoppings</p>
                    </div>
                    <div className="grid grid-cols-2 min-[450px]:grid-cols-3 sm:grid-cols-5 gap-y-6 xl:gap-14 w-full max-lg:max-w-xl">
                        <div className="box flex flex-col items-center">
                            ...
                            <p className="mt-2 font-medium text-sm leading-6  w-[81px] text-center">
                                Free delivery
                            </p>
                        </div>
